IF EXISTS(SELECT *
          ...
          WHERE  [SPECIFIC_SCHEMA] = N'dbo' AND [SPECIFIC_NAME] = N'usp_GetDetailDateList')
    DROP PROCEDURE [dbo].[usp_GetDetailDateList]
GO

CREATE PROCEDURE [usp_GetDetailDateList] @idListXml XML
AS
BEGIN
