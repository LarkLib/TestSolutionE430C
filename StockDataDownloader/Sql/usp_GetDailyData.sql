...
IF EXISTS(SELECT *
          ...
          WHERE  [SPECIFIC_SCHEMA] = N'dbo' AND [SPECIFIC_NAME] = N'usp_GetDailyData')
    DROP PROCEDURE [dbo].[usp_GetDailyData]
GO

CREATE PROCEDURE [usp_GetDailyData] @code NVARCHAR(50),@beginDate DATETIMEOFFSET, @endDate DATETIMEOFFSET, @itervalCount INT = 1
AS
BEGIN
    SELECT  CONVERT(varchar(10), DateTime, 120) AS date, MIN(Price) AS y1, 
...
[usp_GetDailyData] 'sh600519','2015-01-01','2015-02-01'
GO
[usp_GetDailyData] 'sh600132','2000-01-01','2018-01-01'